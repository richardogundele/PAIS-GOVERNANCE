...
class PIIDetector:
    ...
    def is_sensitive(self, text: str, sensitive_keywords: List[str] = None) -> bool:
        """
...
class SpreadsheetRedactor:
    ...
    def process_file(
        ...
        if output_path is None:
            ...
            output_path = str(file_path_obj.parent / f"{file_path_obj.stem}_REDACTED{file_path_obj.suffix}")
        ...
        return {
            "status": "REDACTED",
            "message": f"Redacted {total_redacted} cells in {len(sensitive_columns)} columns",
